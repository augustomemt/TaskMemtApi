...
namespace TaskMemtApi.Migrations
{
    ...
    [Migration("20200306132517_TaskMigration02")]
    partial class TaskMigration02
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskMemtApi.Models.Task", b =>
                {
                    ...
                    b.Property<int?>("NameTaskId");

                    b.Property<int?>("PerformaceAreaId");

                    b.HasKey("Id");

                    b.HasIndex("NameTaskId");
            ...
            modelBuilder.Entity("TaskMemtApi.Models.Task", b =>
                {
                    b.HasOne("TaskMemtApi.Models.Task", "NameTask")
                        .WithMany()
                        .HasForeignKey("NameTaskId");
